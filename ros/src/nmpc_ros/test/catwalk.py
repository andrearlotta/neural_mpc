...
def main():
    ...
    pub_drone_0 = rospy.Publisher('agent_1/cmd/pose', Pose, queue_size=10)
    pub_drone_1 = rospy.Publisher('agent_2/cmd/pose', Pose, queue_size=10)
    pub_drone_2 = rospy.Publisher('agent_3/cmd/pose', Pose, queue_size=10)
